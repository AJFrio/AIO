...
class ComputerUseAgent:
    def __init__(self, api_key: str):
        self.prime = '***If using a web browser, close any popups or notifications.*** /n ***After each step, take a screenshot and carefully evaluate if you have achieved the right outcome. Explicitly show your thinking: "I have evaluated step X..." If not correct, try again. Only when you confirm a step was executed correctly should you move on to the next one.***'
